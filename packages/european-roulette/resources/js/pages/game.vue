<template>
  <div class="d-flex flex-column fill-height py-3">
    ...
    <div class="d-block game-american-roulette-inner">
      <div class="d-none roulette" :class="{ 'd-block': playing }">
        <div v-click-outside="onClickOutsideRoulette" class="rouletteInner">
        ...
        <img src="../../../../../images/roulettestp.webp" class="roulettestp" />
      </div>
      <div class="bets flex-column justify-center align-center d-none" :class="{ 'd-flex bet-ready': !playing }">
        <div class="betsInner">
          <div id="rolls" v-if="rolls.length > 0" class="mb-5 text-no-wrap overflow-hidden">
            <transition-group name="slide-x-reverse-transition" tag="div">
              <v-chip v-for="roll in rolls" :key="roll.time" x-small label :color="roll.color" text-color="#fff"
                class="mr-1">
                {{ roll.number }}
              </v-chip>
            </transition-group>
          ...
          <div class="bets-btns">
            <div v-if="!bettingFinals" class="inner">
              <!-- ZERO -->
              <button :data-betsize="bets['straight0'] ? bets['straight0'] : null" class="bet v3 bnm"
                :class="{ win: win_number == 0, active: active.indexOf(0) != -1, hover: hover.indexOf(0) != -1 }"
                @click="placeBet('straight0')" @contextmenu="e => { e.preventDefault(); removeBet('straight0') }">
                <span>0</span>
              </button>
              <!-- COLUMN 3 -->
              <div class="bets-sup">
                <button v-for="i in 12" :key="`col-3-street-${i}`"
                  :data-betsize="bets['street' + (i * 3 - 2)] ? bets['street' + (i * 3 - 2)] : null" class="betm vt hm"
                  @click="placeBet('street' + (i * 3 - 2))"
                  @contextmenu="e => { e.preventDefault(); removeBet('street' + (i * 3 - 2)) }"
                  @mousedown="active = [i * 3 - 2, i * 3 - 1, i * 3 - 0]" @mouseup="active = []"
                  @mouseover="hover = [i * 3 - 2, i * 3 - 1, i * 3 - 0]" @mouseout="hover = []" />
              </div>
              <div class="bets-sup">
                <button v-for="i in 11" :key="`col-3-sixline-${i}`"
                  :data-betsize="bets['sixline' + (i * 3 - 2)] ? bets['sixline' + (i * 3 - 2)] : null"
                  class="betm vt hr szc" @click="placeBet('sixline' + (i * 3 - 2))"
                  @contextmenu="e => { e.preventDefault(); removeBet('sixline' + (i * 3 - 2)) }"
                  @mousedown="active = [i * 3 - 2, i * 3 - 1, i * 3 - 0, i * 3 + 3, i * 3 + 2, i * 3 + 1]"
                  @mouseup="active = []"
                  @mouseover="hover = [i * 3 - 2, i * 3 - 1, i * 3 - 0, i * 3 + 3, i * 3 + 2, i * 3 + 1]"
                  @mouseout="hover = []" />
              </div>
              <div class="bets-sup">
                <button v-for="i in 11" :key="`col-3-split-${i}`"
                  :data-betsize="bets[`split${i * 3 - 0}_${i * 3 + 3}`] ? bets[`split${i * 3 - 0}_${i * 3 + 3}`] : null"
                  class="betm vm hr szhs" @click="placeBet(`split${i * 3 - 0}_${i * 3 + 3}`)"
                  @contextmenu="e => { e.preventDefault(); removeBet(`split${i * 3 - 0}_${i * 3 + 3}`) }"
                  @mousedown="active = [i * 3 - 0, i * 3 + 3]" @mouseup="active = []"
                  @mouseover="hover = [i * 3 - 0, i * 3 + 3]" @mouseout="hover = []" />
              </div>
              <button v-for="i in 12" :key="'col-3-bet-' + i"
                :data-betsize="bets[`straight${i * 3 - 0}`] ? bets[`straight${i * 3 - 0}`] : null" class="bet"
              ...
              <button class="bet" :data-betsize="bets['column3'] ? bets['column3'] : null" @click="placeBet('column3')"
              ...
              <!-- COLUMN 2 -->
              <div class="bets-sup">
                <button :data-betsize="bets['trio23'] ? bets['trio23'] : null" class="betm vb hl szc "
                  @click="placeBet('trio23')" @contextmenu="e => { e.preventDefault(); removeBet('trio23') }"
                  @mousedown="active = [0, 2, 3]" @mouseup="active = []" @mouseover="hover = [0, 2, 3]"
                  @mouseout="hover = []" />
              </div>
              <div class="bets-sup">
                <button v-for="i in 12" :key="`col-2-split-${i}`"
                  ...
                  @mousedown="active = [i * 3 - 1, i * 3 - 0]" @mouseup="active = []"
                  @mouseover="hover = [i * 3 - 1, i * 3 - 0]" @mouseout="hover = []" />
              </div>
              <div class="bets-sup">
                <button v-for="i in 11" :key="`col-2-corner-${i}`"
                  :data-betsize="bets['corner' + (i * 3 - 1)] ? bets['corner' + (i * 3 - 1)] : null"
                  class="betm vt hr szc" @click="placeBet('corner' + (i * 3 - 1))"
                  @contextmenu="e => { e.preventDefault(); removeBet('corner' + (i * 3 - 1)) }"
                  @mousedown="active = [i * 3 - 1, i * 3, i * 3 + 2, i * 3 + 3]" @mouseup="active = []"
                  @mouseover="hover = [i * 3 - 1, i * 3, i * 3 + 2, i * 3 + 3]" @mouseout="hover = []" />
              </div>
              <div class="bets-sup">
                <button v-for="i in 11" :key="`col-2-split-${i}`"
                  ...
                  @mousedown="active = [i * 3 - 1, i * 3 + 2]" @mouseup="active = []"
                  @mouseover="hover = [i * 3 - 1, i * 3 + 2]" @mouseout="hover = []" />
              </div>
              <div v-for="i in 12" :key="`col-2-bet-${i}`"
              ...
              <div :data-betsize="bets['column2'] ? bets['column2'] : null" class="bet" @click="placeBet('column2')"
              ...
              <div class="bets-sup">
                <button :data-betsize="bets['trio12'] ? bets['trio12'] : null" class="betm vb hl szc "
                  @click="placeBet('trio12')" @contextmenu="e => { e.preventDefault(); removeBet('trio12') }"
                  @mousedown="active = [0, 1, 2]" @mouseup="active = []" @mouseover="hover = [0, 1, 2]"
                  @mouseout="hover = []" />
              </div>
              <div class="bets-sup">
                <button v-for="i in 12" :key="`col-1-split-${i}`"
                  ...
                  @mousedown="active = [i * 3 - 2, i * 3 - 1]" @mouseup="active = []"
                  @mouseover="hover = [i * 3 - 2, i * 3 - 1]" @mouseout="hover = []" />
              </div>
              <div class="bets-sup">
                <button v-for="i in 11" :key="`col-1-corner-${i}`"
                  :data-betsize="bets['corner' + (i * 3 - 2)] ? bets['corner' + (i * 3 - 2)] : null"
                  class="betm vt hr szc" @click="placeBet('corner' + (i * 3 - 2))"
                  @contextmenu="e => { e.preventDefault(); removeBet('corner' + (i * 3 - 2)) }"
                  @mousedown="active = [i * 3 - 2, i * 3 - 1, i * 3 + 1, i * 3 + 2]" @mouseup="active = []"
                  @mouseover="hover = [i * 3 - 2, i * 3 - 1, i * 3 + 1, i * 3 + 2]" @mouseout="hover = []" />
              </div>
              <div class="bets-sup">
              ...
              <div class="bets-sup">
                <button :data-betsize="bets['top_line'] ? bets['top_line'] : null" class="betm vb hl szc "
                  @click="placeBet('top_line')" @contextmenu="e => { e.preventDefault(); removeBet('top_line') }"
                  @mousedown="active = [0, 1, 2, 3]" @mouseup="active = []" @mouseover="hover = [0, 1, 2, 3]"
                  @mouseout="hover = []" />
              </div>
              <button :data-betsize="bets['dozen1'] ? bets['dozen1'] : null" class="bet ml1 h4"
                @mousedown="active = []; for (i = 1; i < 13; i++)active.push(i);" @mouseup="active = []"
                @mouseover="hover = []; for (i = 1; i < 13; i++)hover.push(i);" @mouseout="hover = []"
                @click="placeBet('dozen1')" @contextmenu="e => { e.preventDefault(); removeBet('dozen1') }">
                <span>{{ $t('1st 12') }}</span>
              </button>
              <button :data-betsize="bets['dozen2'] ? bets['dozen2'] : null" class="bet h4"
                ...
                @click="placeBet('dozen2')" @contextmenu="e => { e.preventDefault(); removeBet('dozen2') }">
                <span>{{ $t('2nd 12') }}</span>
              </button>
              <button :data-betsize="bets['dozen3'] ? bets['dozen3'] : null" class="bet mr1 h4"
                ...
                @click="placeBet('dozen3')" @contextmenu="e => { e.preventDefault(); removeBet('dozen3') }">
                <span>{{ $t('3rd 12') }}</span>
              </button>
              <div class="break" />
              <!-- BOTTOM BTNS LINE 2-->
              <button :data-betsize="bets['low'] ? bets['low'] : null" class="bet ml1 h2"
                ...
                @click="placeBet('low')" @contextmenu="e => { e.preventDefault(); removeBet('low') }">
                <span>{{ $t('1 to 18') }}</span>
              </button>
              <button :data-betsize="bets['even'] ? bets['even'] : null" class="bet h2"
                ...
                @click="placeBet('even')" @contextmenu="e => { e.preventDefault(); removeBet('even') }">
                <span>{{ $t('Even') }}</span>
              </button>
              ...
              <button :data-betsize="bets['odd'] ? bets['odd'] : null" class="bet h2"
                ...
                @click="placeBet('odd')" @contextmenu="e => { e.preventDefault(); removeBet('odd') }">
                <span>{{ $t('Odd') }}</span>
              </button>
              <button :data-betsize="bets['high'] ? bets['high'] : null" class="bet mr1 h2"
                ...
                @click="placeBet('high')" @contextmenu="e => { e.preventDefault(); removeBet('high') }">
      ...
      <div class="d-flex justify-center flex-wrap gamethreeBtns" :class="{ 'd-none': playing }">
        <v-btn :disabled="playing || Object.keys(bets_old).length === 0" class="mx-1 my-2 my-lg-0" small @click="repeat">
          <!-- {{ $t('Repeat') }} -->
        ...
        <v-btn :disabled="playing || Object.keys(bets).length === 0" class="mx-1 my-2 my-lg-0" small @click="double">
          {{ $t('2X') }}
        </v-btn>
        <v-btn :disabled="playing || Object.keys(bets).length === 0" class="mx-1 my-2 my-lg-0" small @click="clear">
          <!-- {{ $t('Clear') }} -->
          <svg xmlns="http://www.w3.org/2000/svg" height="1em"
    ...
    <div class="formBottmControllMain">
      <play-controls class="formBottmControll" ref="controls" :loading="loading" :playing="playing"
        :disabled="account.balance < totalBetAmount || totalBetAmount === 0" @bet-change="bet = $event" @play="play">
        <template v-slot:after-bet-input>
          <div class="d-flex align-center inputboxMn totalBetBx">
            <v-text-field :label="$t('Total bet')" :value="totalBetAmount" dense :readonly="!playing" :disabled="playing"
              outlined :full-width="false" class="total-bet-input text-center ml-2" />
          </div>
        </template>
      </play-controls>
    </div>
...
import ballImg from 'packages/european-roulette/resources/images/ball.png'
...
export default {
  ...
  data() {
    return {
      ...
      bet: 0,
      win: 0,
      max_bet: parseInt(config('european-roulette.max_bet'), 10),
      min_bet: parseInt(config('european-roulette.min_bet'), 10),
      rolls: [],
      ready: false,
      message: null,
      bets_roulette: {},
        ...
        calculate: () => {
          switch (this.animation.animation_stage) {
            ...
            case 11:
              ...
              break
            case 12:
              this.animation.wheel_speed -= (this.animation.game_t - this.animation.t) * 0.0000001
              if (this.animation.wheel_speed <= 0) {
