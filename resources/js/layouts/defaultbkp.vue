<template>
  <v-app :class="navbarVisible ? 'permanent-navbar' : 'temporary-navbar'" :style="style">
    ...
    <!-- <template v-if="isMobile && (isPredictionPage || isProviderGamePage)"> -->
    ...
    <v-app-bar v-else app :clipped-left="!navbarVisible" :color="appBarBackground">
      ...
      <template v-if="!token && !authenticated">
        <v-btn :to="{ name: 'login' }" class="secondary conectwalletBtn">
          {{ $t('Connect Wallet') }}
        </v-btn>
    ...
    <v-main>
      <!-- <div class="marquee">
        <marquee behavior="scroll" direction="Left">
          <span>
            VTC Withdrawals Are Now Live on HashFair Games... &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img
              src="../../../images/marqueelogo.webp" width="40" height="40"
              alt="Hash Fair Logo" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Staking for VTC Coin is Now Live... &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../../../images/marqueelogo.webp"
              width="40" height="40" alt="Hash Fair Logo" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              Mainnet Web3 Games are live. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../../../images/marqueelogo.webp"
              width="40" height="40" alt="Hash Fair Logo" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Hashfair NFT Marketplace is live Now, Go and Buy Your Share with VTC... &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img
              src="../../../images/marqueelogo.webp" width="40" height="40"
              alt="Hash Fair Logo" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          </span>
        </marquee>
      </div> -->
      <div class="container notificationMsg" v-if="showNotification">
        <p>Dear users, we regret to inform you that your withdrawal has been canceled as the game
          was in testing mode. Your
          deposited amount has been reverted. We apologize for any inconvenience. Thank you for your understanding.</p>
      </div>
      <message />
...
export default {
  ...
  computed: {
    ...
    showNotification() {
        return this.user && (this.user.id === 8789778);
    },
    appName() {
