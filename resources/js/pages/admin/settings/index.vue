    ...
    <v-card>
      ...
      <v-card-text>
        <v-form v-model="formIsValid" @submit.prevent="save">
          <v-tabs vertical color="primary" class="gap-4 bg-transparent">
            <v-card>
              <v-tab>
                {{ $t('General') }}
              </v-tab>
              ...
              <v-card flat>
                <v-card-text>
                  <v-expansion-panels>
                    ...
                    <v-expansion-panel>
                      <v-expansion-panel-header>{{ $t('Faucet') }}</v-expansion-panel-header>
                      <v-expansion-panel-content>
                        <v-row>
                          <v-col cols="12" md="6">
                            <v-text-field
                  ...
                  <v-expansion-panels>
                    ...
                    <v-expansion-panel>
                      ...
                      <v-expansion-panel-content>
                        ...
                        <v-text-field
                          v-show="form.BROADCAST_DRIVER !== 'null'"
              ...
              <v-card flat>
                <v-card-text>
                  ...
                  <v-select
                    ...
                    :items="logLevels"
                    :label="$t('Log level')"
                    :error="form.errors.has('LOG_LEVEL')"
                    :error-messages="form.errors.get('LOG_LEVEL')"
                    outlined
                  />
