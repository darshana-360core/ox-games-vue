                      ...
                      <v-expansion-panel-content>
                        <entity-parameters v-if="method" v-model="form.parameters">
                          <template #description>
                            <p>
                              {{ $t('Add any number of extra parameters that should be present on the deposit form and filled in by the user.') }}
                            </p>
                          </template>
                        </entity-parameters>
                      </v-expansion-panel-content>
...
export default {
  components: { FileUpload, DepositMethodMenu, Preloader, EntityParameters, FormParameter },
