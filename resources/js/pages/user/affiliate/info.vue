      ...
      <v-col cols="12" lg="6">
        <v-card>
          ...
          <v-card-text>
            ...
            <v-text-field ref="link" :value="user.affiliate_url" :label="$t('Your affiliate link')"
              append-icon="mdi-content-copy" outlined readonly
              ...
              <template #append-outer>
                <v-menu offset-y>
                  ...
                  <v-list>
                    ...
                    <v-list-item :href="'https://twitter.com/intent/tweet?text=&url=' + affiliateUrlEncoded"
                      target="_blank">
                      <v-list-item-icon>
            ...
            <v-simple-table>
              <template #default>
                ...
                <tbody>
                  ...
                  <tr
                    v-if="commission('game_loss', 0) > 0 || commission('game_loss', 1) > 0 || commission('game_loss', 2) > 0">
                  ...
                  <tr
                    v-if="commission('game_win', 0) > 0 || commission('game_win', 1) > 0 || commission('game_win', 2) > 0">
                  ...
                  <tr
                    v-if="commission('raffle_ticket', 0) > 0 || commission('raffle_ticket', 1) > 0 || commission('raffle_ticket', 2) > 0">
