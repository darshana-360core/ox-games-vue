<template>
  <v-menu v-model="menu" :close-on-content-click="false" offset-y left v-if="!isMobile">
    <template #activator="{ on }">
      <v-btn class="setting-btn" icon v-on="on" style="background-color: rgba(255,255,255,0.15);">
