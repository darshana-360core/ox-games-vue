<template>
  <v-footer
    ...
    :inset="inset"
    :color="background"
    class="d-block mt-10 px-5 py-10 text--secondary text--darken-3 mx-0"
  >
    <v-row class="my-0">
      <v-col cols="12" sm="6" lg="3">
        <div class="footer-logo d-flex mb-3">
          ...
          <h4 class="d-inline ml-2 text-h5 font-weight-normal">
            {{ appName }}
          </h4>
        </div>
        <v-row class="mt-0">
          <v-col class="gaming-banners text-center">
            <div class="gaming-banner-item">
      ...
      <v-col cols="12" sm="6" lg="3">
        <h3 class="footer-title">Top Games</h3>
        <div class="games-list">
          ...
          <router-link
            ...
            :key="i"
            :to="game.route"
            class="text-decoration-none text--secondary mx-0 my-0"
          >
            {{ game.name }}
          </router-link>
      ...
      <v-col cols="12" sm="6" lg="3" v-if="links">
        <h3 class="footer-title">Join Our Community</h3>
        <ul class="social-icons pl-0 d-flex items-start flex-column">
    ...
    <!-- <v-row>
      <v-col class="text-center">
        <div class="footer-logo d-flex align-center justify-center">
          ...
          <h4 class="d-inline ml-3 text-h4 font-weight-normal">
            {{ appName }}
          </h4>
        </div>
      </v-col>
    ...
    <!-- <v-row>
      <v-col class="games-list d-flex flex-wrap align-center justify-center">
        ...
        <router-link
          ...
          :key="i"
          :to="game.route"
          class="text-decoration-none text--secondary mx-2 my-2 my-lg-0"
        >
          {{ game.name }}
        </router-link>
        <game-search-modal v-if="games.length > 5">
