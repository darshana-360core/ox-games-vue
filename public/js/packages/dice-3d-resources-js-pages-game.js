"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["packages/dice-3d-resources-js-pages-game"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./packages/dice-3d/resources/js/pages/game.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./packages/dice-3d/resources/js/pages/game.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************/
...
/* harmony import */ var packages_dice_3d_resources_js_components_dice_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! packages/dice-3d/resources/js/components/dice.js */ "./packages/dice-3d/resources/js/components/dice.js");
...
/* harmony import */ var _plugins_format__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ~/plugins/format */ "./resources/js/plugins/format.js");
...
/* harmony import */ var _plugins_utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ~/plugins/utils */ "./resources/js/plugins/utils.js");
...
/* harmony import */ var packages_dice_3d_resources_audio_win_wav__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! packages/dice-3d/resources/audio/win.wav */ "./packages/dice-3d/resources/audio/win.wav");
/* harmony import */ var packages_dice_3d_resources_audio_roll1_wav__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! packages/dice-3d/resources/audio/roll1.wav */ "./packages/dice-3d/resources/audio/roll1.wav");
/* harmony import */ var packages_dice_3d_resources_audio_roll2_wav__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! packages/dice-3d/resources/audio/roll2.wav */ "./packages/dice-3d/resources/audio/roll2.wav");
/* harmony import */ var packages_dice_3d_resources_audio_lose_wav__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! packages/dice-3d/resources/audio/lose.wav */ "./packages/dice-3d/resources/audio/lose.wav");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      roll1Sound: packages_dice_3d_resources_audio_roll1_wav__WEBPACK_IMPORTED_MODULE_12__["default"],
      roll2Sound: packages_dice_3d_resources_audio_roll2_wav__WEBPACK_IMPORTED_MODULE_13__["default"],
      formIsValid: true,
      loading: false,
      playing: false,
      refNumber: null,
      direction: -1,
      diceFillColor: (0,_plugins_config__WEBPACK_IMPORTED_MODULE_4__.config)('dice-3d.fill_color'),
      diceFontColor: (0,_plugins_config__WEBPACK_IMPORTED_MODULE_4__.config)('dice-3d.font_color'),
      bet: parseInt((0,_plugins_config__WEBPACK_IMPORTED_MODULE_4__.config)('dice-3d.default_bet_amount'), 10),
      roll: 0,
      message: null,
      animation: {}
    };
  },
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_17__.mapState)('auth', ['account'])), {}, {
    dices: function dices() {
      return (0,_plugins_config__WEBPACK_IMPORTED_MODULE_4__.config)('dice-3d.dice');
    },
    minRoll: function minRoll() {
      return (0,_plugins_config__WEBPACK_IMPORTED_MODULE_4__.config)('dice-3d.dice').length;
    },
    maxRoll: function maxRoll() {
      return (0,_plugins_config__WEBPACK_IMPORTED_MODULE_4__.config)('dice-3d.dice').reduce(function (a, id) {
        a += (0,_plugins_config__WEBPACK_IMPORTED_MODULE_4__.config)('dice-3d.dice_types')[id].max;
        return a;
      }, 0);
    },
    ...
    houseEdge: function houseEdge() {
      return (0,_plugins_config__WEBPACK_IMPORTED_MODULE_4__.config)('dice-3d.house_edge');
    },
    winChance: function winChance() {
      var winChance = this.direction === -1 ? (this.refNumber - this.minRoll) / this.rollsRangeLength * 100 : (this.maxRoll - this.refNumber + 1) / this.rollsRangeLength * 100;
      return (0,_plugins_utils__WEBPACK_IMPORTED_MODULE_9__.round)(winChance, 2);
    },
    payout: function payout() {
      var payout = (100 - this.houseEdge) / this.winChance;
      return (0,_plugins_utils__WEBPACK_IMPORTED_MODULE_9__.round)(payout, 4);
    },
    rollLessText: function rollLessText() {
      return this.minRoll < this.refNumber - 1 ? this.$t('Roll {0} - {1}', [this.minRoll, this.refNumber - 1]) : this.$t('Roll {0}', [this.refNumber - 1]);
    },
    rollGreaterText: function rollGreaterText() {
      return this.maxRoll > this.refNumber ? this.$t('Roll {0} - {1}', [this.refNumber, this.maxRoll]) : this.$t('Roll {0}', [this.refNumber]);
    },
  ...
  mounted: function mounted() {
    ...
    this.animation = {
      ...
      animate: function animate() {
        ...
        if (_this.animation.isThrought) {
          for (i in _this.animation.dice) {
            if (_this.animation.diceValues[i].steps.length > _this.animation.diceAnimationStep) _this.animation.dice[i].setMeshFrom(_this.animation.diceValues[i].steps[_this.animation.diceAnimationStep]);
            if (_this.animation.diceValues[i].sound.length > _this.animation.diceAnimationStep && _this.animation.diceValues[i].sound[_this.animation.diceAnimationStep] && _this.animation.diceValues[i].lastSound < _this.animation.diceAnimationStep) {
              if (_this.animation.diceValues[i].lastSound === 0) _this.sound(_this.roll1Sound);else _this.sound(_this.roll2Sound);
              _this.animation.diceValues[i].lastSound = _this.animation.diceAnimationStep + 5;
            }
          }
          _this.animation.diceAnimationStep++;
        }
        ...
        if (_this.animation.isThrought) {
          var isFinished = true;
          for (i = 0; i < _this.animation.dice.length; i++) isFinished = isFinished && !(_this.animation.diceValues[i].steps.length > _this.animation.diceAnimationStep);
          if (isFinished) {
            _this.playing = false;
            _this.updateUserAccountBalance(_this.animation.result.balance);
            if (_this.animation.result.win > 0) {
              _this.sound(_this.config.sounds.win || packages_dice_3d_resources_audio_win_wav__WEBPACK_IMPORTED_MODULE_11__["default"]);
              _this.message = _this.$t('You rolled') + ' ' + _this.roll + ' ' + _this.$t('and won') + ' ' + (0,_plugins_format__WEBPACK_IMPORTED_MODULE_5__.decimal)(_this.animation.result.win);
            } else {
              _this.sound(_this.config.sounds.lose || packages_dice_3d_resources_audio_lose_wav__WEBPACK_IMPORTED_MODULE_14__["default"]);
              _this.message = _this.$t('You rolled') + ' ' + _this.roll;
            }
    ...
    packages_dice_3d_resources_js_components_dice_js__WEBPACK_IMPORTED_MODULE_2__.DiceManager.setWorld(this.animation.world);
    // Floor
    var floorBody = new cannon__WEBPACK_IMPORTED_MODULE_0__.Body({
      mass: 0,
      shape: new cannon__WEBPACK_IMPORTED_MODULE_0__.Plane(),
      material: packages_dice_3d_resources_js_components_dice_js__WEBPACK_IMPORTED_MODULE_2__.DiceManager.floorBodyMaterial
    });
    ...
    barrier = new cannon__WEBPACK_IMPORTED_MODULE_0__.Body({
      mass: 0,
      shape: new cannon__WEBPACK_IMPORTED_MODULE_0__.Plane(),
      material: packages_dice_3d_resources_js_components_dice_js__WEBPACK_IMPORTED_MODULE_2__.DiceManager.barrierBodyMaterial
    });
    ...
    var fontColor = this.diceFontColor;
    // const backColor = getComputedStyle(document.body).getPropertyValue('--v-primary-base').trim()
    var backColor = this.diceFillColor;
    // const backColors = ['#ff0000','#00ff00','#0000ff','#777700','#770077','#007777']
    this.dices.forEach(function (dice, i) {
      var d;
      switch (dice) {
        case 'tetrahedron':
          d = new packages_dice_3d_resources_js_components_dice_js__WEBPACK_IMPORTED_MODULE_2__.DiceD4({
            size: 1.5,
            backColor: backColor,
            fontColor: fontColor
          });
          ...
          break;
        case 'cube':
          d = new packages_dice_3d_resources_js_components_dice_js__WEBPACK_IMPORTED_MODULE_2__.DiceD6({
            size: 1.5,
            backColor: backColor,
            fontColor: fontColor
          });
          ...
          break;
        case 'octahedron':
          d = new packages_dice_3d_resources_js_components_dice_js__WEBPACK_IMPORTED_MODULE_2__.DiceD8({
            size: 1.5,
            backColor: backColor,
            fontColor: fontColor
          });
          ...
          break;
        case 'dipyramid':
          d = new packages_dice_3d_resources_js_components_dice_js__WEBPACK_IMPORTED_MODULE_2__.DiceD10({
            size: 1.5,
            backColor: backColor,
            fontColor: fontColor
          });
          ...
          break;
        case 'dodecahedron':
          d = new packages_dice_3d_resources_js_components_dice_js__WEBPACK_IMPORTED_MODULE_2__.DiceD12({
            size: 1.5,
            backColor: backColor,
            fontColor: fontColor
          });
          ...
          break;
        case 'icosahedron':
          d = new packages_dice_3d_resources_js_components_dice_js__WEBPACK_IMPORTED_MODULE_2__.DiceD20({
            size: 1.5,
            backColor: backColor,
            fontColor: fontColor
          });
      ...
      _this.animation.scene.add(d.getObject());
      _this.animation.dice.push(d);
    });
    this.animation.diceThrow = function () {
      if (_this.animation.pos == null) _this.animation.randomDiceThrow();
      var pos = _this.animation.pos;
      var velocity = _this.animation.velocity;
      _this.animation.isThrought = true;
      _this.animation.diceAnimationStep = 0;
      _this.animation.diceValues = [];
      ...
      var i;
      for (i = 0; i < _this.animation.dice.length; i++) {
        _this.animation.dice[i].getObject().position.x = pos.x - i % 3 * 1.5;
        _this.animation.dice[i].getObject().position.y = pos.y + Math.floor(i / 3) * 1.5;
        _this.animation.dice[i].getObject().position.z = pos.z + i % 3 * 1.5;
        ...
        _this.animation.dice[i].updateBodyFromMesh();
        // const yRand = Math.random() * 10
        // const rand = Math.random() * 1 + 1
        _this.animation.dice[i].getObject().body.velocity.set(velocity.x, velocity.y, velocity.z);
        _this.animation.dice[i].getObject().body.angularVelocity.set(10 * Math.random() - 10, 10 * Math.random() - 10, 10 * Math.random() - 10);
        _this.animation.diceValues.push({
          dice: _this.animation.dice[i],
          value: i + 1
        });
      }
      var roll = _this.roll;
      for (i = 0; i < _this.animation.diceValues.length; i++) {
        _this.animation.diceValues[i].value = Math.ceil(Math.random() * Math.min(_this.animation.diceValues[i].dice.values, roll - (_this.animation.diceValues.length - i - 1)));
        roll -= _this.animation.diceValues[i].value;
      }
      while (roll > 0) {
        for (i = 0; i < _this.animation.diceValues.length; i++) {
          if (_this.animation.diceValues[i].value < _this.animation.diceValues[i].dice.values) {
            var add = Math.ceil(Math.random() * Math.min(_this.animation.diceValues[i].dice.values - _this.animation.diceValues[i].value, roll));
            _this.animation.diceValues[i].value += add;
            roll -= add;
            if (roll <= 0) break;
          }
        }
      }
      packages_dice_3d_resources_js_components_dice_js__WEBPACK_IMPORTED_MODULE_2__.DiceManager.prepareValues(_this.animation.diceValues, floorBody);
      _this.animation.pos = null;
      _this.animation.velocity = null;
    };
    var makeRandomVector = function makeRandomVector(vector) {
      var rnd = Math.random();
    ...
    this.animation.randomDiceThrow = function () {
      var rnd = Math.random();
      var vector = {
        x: (rnd * 2 - 1) * _this.animation.floorWidth,
        y: -(rnd * 2 - 1) * _this.animation.floorHeight
      };
      ...
      var pos = {
        x: _this.animation.floorWidth / 2 * (vec.x > 0 ? -1 : 1) * 0.9,
        y: 10,
        z: _this.animation.floorHeight / 2 * (vec.y > 0 ? -1 : 1) * 0.9
      };
      ...
      _this.animation.pos = pos;
      _this.animation.velocity = velocity;
    };
    ...
    var mouseStart = function mouseStart(ev) {
      ev.preventDefault();
      if (_this.playing) return;
      _this.animation.mouse_time = new Date().getTime();
      _this.animation.mouse_start = getMouseCoords(ev);
    };
    var mouseEnd = function mouseEnd(ev) {
      if (_this.animation.mouse_start === undefined) return;
      ev.stopPropagation();
      var m = getMouseCoords(ev);
      var vector = {
        x: m.x - _this.animation.mouse_start.x,
        y: m.y - _this.animation.mouse_start.y
      };
      _this.animation.mouse_start = undefined;
      var dist = Math.sqrt(vector.x * vector.x + vector.y * vector.y);
      if (dist < Math.sqrt(_this.animation.floorWidth * _this.animation.floorHeight * 0.01)) return;
      var timeInt = new Date().getTime() - _this.animation.mouse_time;
    ...
    this.animation.start = function () {
      _this.animation.diceValues = [];
      for (var i = 0; i < _this.animation.dice.length; i++) {
        _this.animation.dice[i].getObject().position.x = i % 3 * 1.7;
        _this.animation.dice[i].getObject().position.y = 15 + Math.floor(i / 3) * 1.7;
        _this.animation.dice[i].getObject().position.z = i % 3 * 1.7;
        _this.animation.dice[i].getObject().quaternion.x = 0;
        _this.animation.dice[i].getObject().quaternion.y = 0;
        _this.animation.dice[i].getObject().quaternion.z = 0;
        _this.animation.dice[i].updateBodyFromMesh();
        _this.animation.dice[i].getObject().body.velocity.set(0, 10, 0);
        _this.animation.dice[i].getObject().body.angularVelocity.set(0, 5, 0);
        _this.animation.diceValues.push({
          dice: _this.animation.dice[i],
          value: i + 1
        });
      ...
      packages_dice_3d_resources_js_components_dice_js__WEBPACK_IMPORTED_MODULE_2__.DiceManager.prepareValues(_this.animation.diceValues, floorBody);
      _this.animation.dice.forEach(function (dice) {
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              requestParams = {
                ...
                ref_number: _this2.refNumber
              }; // execute the action
              _context.next = 8;
              return axios__WEBPACK_IMPORTED_MODULE_3___default().post(endpoint, requestParams);
            case 8:
              _yield$axios$post = _context.sent;
              game = _yield$axios$post.data;
              _this2.loading = false;
              _this2.roll = game.gameable.roll;
              _this2.setProvablyFairGame({
                key: _this2.gamePackageId,
                game: game.pf_game
              });
              _this2.animation.result = {
                balance: game.account.balance,
                win: game.win
              };
              _this2.animation.diceThrow();
...
/***/ "./packages/dice-3d/resources/js/components/dice.js":
/*!**********************************************************!*\
  !*** ./packages/dice-3d/resources/js/components/dice.js ***!
  \**********************************************************/
...
/***/ "./packages/dice-3d/resources/audio/lose.wav":
/*!***************************************************!*\
  !*** ./packages/dice-3d/resources/audio/lose.wav ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "audio/dice-3d/lose.wav");

/***/ }),

/***/ "./packages/dice-3d/resources/audio/roll1.wav":
/*!****************************************************!*\
  !*** ./packages/dice-3d/resources/audio/roll1.wav ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "audio/dice-3d/roll1.wav");

/***/ }),

/***/ "./packages/dice-3d/resources/audio/roll2.wav":
/*!****************************************************!*\
  !*** ./packages/dice-3d/resources/audio/roll2.wav ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "audio/dice-3d/roll2.wav");

/***/ }),

/***/ "./packages/dice-3d/resources/audio/win.wav":
/*!**************************************************!*\
  !*** ./packages/dice-3d/resources/audio/win.wav ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "audio/dice-3d/win.wav");
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-11.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./packages/dice-3d/resources/js/pages/game.vue?vue&type=style&index=0&id=f67d6266&lang=scss&scoped=true&":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-11.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./packages/dice-3d/resources/js/pages/game.vue?vue&type=style&index=0&id=f67d6266&lang=scss&scoped=true& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".animation[data-v-f67d6266] {\n  width: 100%;\n  max-width: 1200px;\n  height: 350px;\n  z-index: 3;\n}\n.animation[data-v-f67d6266] canvas {\n  z-index: 3;\n  width: 100% !important;\n  height: auto !important;\n}\n.message-container[data-v-f67d6266] {\n  position: relative;\n  height: 0;\n  z-index: 2;\n}\n.message-container .message[data-v-f67d6266] {\n  position: absolute;\n  top: 5px;\n  left: 50%;\n  transform: translateX(-50%);\n}", ""]);
// Exports
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_11_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_11_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_11_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_game_vue_vue_type_style_index_0_id_f67d6266_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!../../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-11.use[3]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./game.vue?vue&type=style&index=0&id=f67d6266&lang=scss&scoped=true& */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-11.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./packages/dice-3d/resources/js/pages/game.vue?vue&type=style&index=0&id=f67d6266&lang=scss&scoped=true&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_11_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_11_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_11_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_game_vue_vue_type_style_index_0_id_f67d6266_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./packages/dice-3d/resources/js/pages/game.vue":
/*!******************************************************!*\
  !*** ./packages/dice-3d/resources/js/pages/game.vue ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _game_vue_vue_type_template_id_f67d6266_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./game.vue?vue&type=template&id=f67d6266&scoped=true& */ "./packages/dice-3d/resources/js/pages/game.vue?vue&type=template&id=f67d6266&scoped=true&");
/* harmony import */ var _game_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./game.vue?vue&type=script&lang=js& */ "./packages/dice-3d/resources/js/pages/game.vue?vue&type=script&lang=js&");
/* harmony import */ var _game_vue_vue_type_style_index_0_id_f67d6266_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./game.vue?vue&type=style&index=0&id=f67d6266&lang=scss&scoped=true& */ "./packages/dice-3d/resources/js/pages/game.vue?vue&type=style&index=0&id=f67d6266&lang=scss&scoped=true&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _game_vue_vue_type_template_id_f67d6266_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _game_vue_vue_type_template_id_f67d6266_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "f67d6266",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/dice-3d/resources/js/pages/game.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./packages/dice-3d/resources/js/pages/game.vue?vue&type=script&lang=js&":
/*!*******************************************************************************!*\
  !*** ./packages/dice-3d/resources/js/pages/game.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./packages/dice-3d/resources/js/pages/game.vue?vue&type=style&index=0&id=f67d6266&lang=scss&scoped=true&":
/*!****************************************************************************************************************!*\
  !*** ./packages/dice-3d/resources/js/pages/game.vue?vue&type=style&index=0&id=f67d6266&lang=scss&scoped=true& ***!
  \****************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_11_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_11_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_11_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_game_vue_vue_type_style_index_0_id_f67d6266_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!../../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-11.use[3]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./game.vue?vue&type=style&index=0&id=f67d6266&lang=scss&scoped=true& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-11.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./packages/dice-3d/resources/js/pages/game.vue?vue&type=style&index=0&id=f67d6266&lang=scss&scoped=true&");
...
/***/ "./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./packages/dice-3d/resources/js/pages/game.vue?vue&type=template&id=f67d6266&scoped=true&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./packages/dice-3d/resources/js/pages/game.vue?vue&type=template&id=f67d6266&scoped=true& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var vuetify_lib_components_VBtnToggle__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! vuetify/lib/components/VBtnToggle */ "./node_modules/vuetify/lib/components/VBtnToggle/VBtnToggle.js");
...
/* harmony import */ var vuetify_lib_components_VSlider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vuetify/lib/components/VSlider */ "./node_modules/vuetify/lib/components/VSlider/VSlider.js");
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_c(vuetify_lib_components_VSlider__WEBPACK_IMPORTED_MODULE_0__["default"], {
    staticClass: "px-5",
    attrs: {
      "thumb-label": "always",
    ...
    scopedSlots: _vm._u([{
      key: "prepend",
      fn: function fn() {
        return [_c(vuetify_lib_components_VIcon__WEBPACK_IMPORTED_MODULE_1__["default"], {
          on: {
  ...
  }, [_c(vuetify_lib_components_VForm__WEBPACK_IMPORTED_MODULE_2__["default"], {
  ...
  })], 1)], 1)], 1), _vm._v(" "), _c(vuetify_lib_components_VBtnToggle__WEBPACK_IMPORTED_MODULE_5__["default"], {
...
/***/ "./packages/dice-3d/resources/js/pages/game.vue?vue&type=template&id=f67d6266&scoped=true&":
/*!*************************************************************************************************!*\
  !*** ./packages/dice-3d/resources/js/pages/game.vue?vue&type=template&id=f67d6266&scoped=true& ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_game_vue_vue_type_template_id_f67d6266_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_game_vue_vue_type_template_id_f67d6266_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_game_vue_vue_type_template_id_f67d6266_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./game.vue?vue&type=template&id=f67d6266&scoped=true& */ "./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./packages/dice-3d/resources/js/pages/game.vue?vue&type=template&id=f67d6266&scoped=true&");
