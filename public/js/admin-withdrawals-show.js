(self["webpackChunk"] = self["webpackChunk"] || []).push([["admin-withdrawals-show"],{
...
/***/ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/withdrawals/show.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/withdrawals/show.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var packages_payments_resources_js_components_Admin_WithdrawalMenu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! packages/payments/resources/js/components/Admin/WithdrawalMenu */ "./packages/payments/resources/js/components/Admin/WithdrawalMenu.vue");
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ethers */ "./node_modules/ethers/lib.esm/providers/provider-browser.js");
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ethers */ "./node_modules/ethers/lib.esm/contract/contract.js");
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ethers */ "./node_modules/ethers/lib.esm/utils/units.js");
/* harmony import */ var packages_payments_resources_js_static_contract_abi__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! packages/payments/resources/js/static/contract-abi */ "./packages/payments/resources/js/static/contract-abi.json");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    WithdrawalMenu: packages_payments_resources_js_components_Admin_WithdrawalMenu__WEBPACK_IMPORTED_MODULE_5__["default"],
  ...
  computed: {
    config: function config() {
      return (0,_plugins_config__WEBPACK_IMPORTED_MODULE_2__.config)('payments');
    },
  ...
  methods: {
    get: _plugins_utils__WEBPACK_IMPORTED_MODULE_3__.get,
    ucfirst: _plugins_utils__WEBPACK_IMPORTED_MODULE_3__.ucfirst,
    ...
    createEvmTransaction: function createEvmTransaction() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var web3, addresses, transaction, provider, signer, contractInstance, txn;
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _this2.$store.dispatch('message/error', {
                text: _this2.$t('Please check that a {0} compatible wallet (such as {1}) is installed and enabled in your browser.', ['Web3', 'Metamask'])
              });
              return _context2.abrupt("return", false);
            case 3:
              _this2.transactionInProgress = true;
              web3 = new (web3__WEBPACK_IMPORTED_MODULE_6___default())((web3__WEBPACK_IMPORTED_MODULE_6___default().givenProvider));
              _context2.prev = 5;
              _context2.next = 8;
            ...
            case 11:
              ...
              _this2.$store.dispatch('message/error', {
                text: _context2.t0.code === 4001 ? _this2.$t('Access to your account is not authorized') : _context2.t0.message
              });
            case 14:
              if (!addresses) {
                _context2.next = 37;
              ...
              _context2.prev = 15;
              if (!(['evm_token'].indexOf(_this2.withdrawal.method.payment_method.code) > -1)) {
                _context2.next = 28;
                break;
              }
              ...
              //   data
              // })
              provider = new ethers__WEBPACK_IMPORTED_MODULE_9__.BrowserProvider(window.ethereum);
              _context2.next = 20;
              return provider.getSigner();
            case 20:
              signer = _context2.sent;
              contractInstance = new ethers__WEBPACK_IMPORTED_MODULE_10__.Contract(_this2.withdrawal.parameters.contractAddress, packages_payments_resources_js_static_contract_abi__WEBPACK_IMPORTED_MODULE_7__, signer);
              _context2.next = 24;
              return contractInstance.transfer.send(_this2.withdrawal.parameters.contractAddress, _this2.withdrawal.payment_amount_in_units, {
                gasPrice: ethers__WEBPACK_IMPORTED_MODULE_11__.parseUnits("300", "gwei")
              });
            case 24:
              txn = _context2.sent;
              transaction = {
            ...
            case 28:
              ...
              return web3.eth.sendTransaction({
                from: addresses[0],
                to: _this2.withdrawal.parameters.address,
                value: _this2.withdrawal.payment_amount_in_units
              });
            case 30:
            ...
            case 33:
              ...
              _this2.$store.dispatch('message/error', {
                text: _context2.t1.code === 4001 ? _this2.$t('Transaction is not authorized') : _context2.t1.message
              });
            case 36:
              if (transaction) {
                _this2.action('complete', {
                  external_id: transaction.transactionHash
                });
              }
            case 37:
              _this2.transactionInProgress = false;
            case 38:
            case "end":
              return _context2.stop();
          }
        }, _callee2, null, [[5, 11], [15, 33]]);
      }))();
    },
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _this3.$store.dispatch('message/error', {
                text: _this3.$t('Please check that a {0} compatible wallet (such as {1}) is installed and enabled in your browser.', ['Tronweb', 'Tronlink'])
              });
            ...
            case 3:
              ...
              _context3.prev = 7;
              if (!(_this3.withdrawal.method.payment_method.code === 'trc20')) {
                _context3.next = 20;
                break;
              }
              _context3.next = 11;
              return web.trx.getContract(_this3.withdrawal.parameters.contractAddress);
            case 11:
              _yield$web$trx$getCon = _context3.sent;
              abi = _yield$web$trx$getCon.abi;
              contract = web.contract(abi.entrys, _this3.withdrawal.parameters.contractAddress);
              _context3.next = 16;
              return contract.methods.transfer(web.address.toHex(_this3.withdrawal.parameters.address), _this3.withdrawal.payment_amount_in_units).send();
            case 16:
            ...
            case 20:
              _context3.next = 22;
              return web.transactionBuilder.sendTrx(web.address.toHex(_this3.withdrawal.parameters.address), _this3.withdrawal.payment_amount_in_units, address);
            case 22:
            ...
            case 28:
              _yield$web$trx$sendRa = _context3.sent;
            ...
            case 34:
              ...
              _this3.$store.dispatch('message/error', {
                text: _context3.t0.message || _context3.t0
              });
            case 37:
              _context3.next = 40;
              break;
            case 39:
              _this3.$store.dispatch('message/error', {
                text: _this3.$t('Access to your account is not authorized')
              });
            case 40:
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              if ((0,_plugins_utils__WEBPACK_IMPORTED_MODULE_3__.get)(window, 'solana.isPhantom', false)) {
                _context4.next = 3;
                break;
              }
              _this4.$store.dispatch('message/error', {
                text: _this4.$t('Phantom wallet is not detected.')
              });
            ...
            case 12:
              ...
              _context4.prev = 13;
              url = _this4.withdrawal.method.payment_method_parameters.url;
              connection = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_8__.Connection(url, 'finalized');
              _context4.next = 18;
              return connection.getLatestBlockhash('finalized');
            case 18:
              recentBlockhash = _context4.sent;
              transaction = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_8__.Transaction().add(_solana_web3_js__WEBPACK_IMPORTED_MODULE_8__.SystemProgram.transfer({
                fromPubkey: window.solana.publicKey,
                toPubkey: new _solana_web3_js__WEBPACK_IMPORTED_MODULE_8__.PublicKey(_this4.withdrawal.parameters.address),
                lamports: _this4.withdrawal.payment_amount_in_units
              }));
            ...
            case 24:
              _yield$window$solana$ = _context4.sent;
            ...
            case 29:
              ...
              _this4.$store.dispatch('message/error', {
                text: _context4.t1.message || _context4.t1
              });
            case 32:
...
/***/ "./resources/js/pages/admin/withdrawals/show.vue":
/*!*******************************************************!*\
  !*** ./resources/js/pages/admin/withdrawals/show.vue ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _show_vue_vue_type_template_id_ce223f12___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./show.vue?vue&type=template&id=ce223f12& */ "./resources/js/pages/admin/withdrawals/show.vue?vue&type=template&id=ce223f12&");
/* harmony import */ var _show_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./show.vue?vue&type=script&lang=js& */ "./resources/js/pages/admin/withdrawals/show.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _show_vue_vue_type_template_id_ce223f12___WEBPACK_IMPORTED_MODULE_0__.render,
  _show_vue_vue_type_template_id_ce223f12___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/admin/withdrawals/show.vue"
...
/***/ "./resources/js/pages/admin/withdrawals/show.vue?vue&type=script&lang=js&":
/*!********************************************************************************!*\
  !*** ./resources/js/pages/admin/withdrawals/show.vue?vue&type=script&lang=js& ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/withdrawals/show.vue?vue&type=template&id=ce223f12&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/withdrawals/show.vue?vue&type=template&id=ce223f12& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_0__["default"], [_c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    }], null, false, 1660656121)
  }, [_vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.$t("Approve request and send funds to user through API.")))])]) : _vm._e(), _vm._v(" "), _vm.withdrawal.is_created && ["evm"].indexOf(_vm.get(_vm.withdrawal, "method.payment_method.gateway.code")) > -1 ? _c(vuetify_lib_components_VTooltip__WEBPACK_IMPORTED_MODULE_11__["default"], {
    attrs: {
      bottom: ""
    },
    scopedSlots: _vm._u([{
  ...
  }, [_vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.$t("Make a payment using the Phantom Wallet.")))])]) : _vm._e(), _vm._v(" "), _vm.withdrawal.is_created || _vm.withdrawal.is_pending ? _c(vuetify_lib_components_VTooltip__WEBPACK_IMPORTED_MODULE_11__["default"], {
    attrs: {
      bottom: ""
    },
    scopedSlots: _vm._u([{
...
/***/ "./resources/js/pages/admin/withdrawals/show.vue?vue&type=template&id=ce223f12&":
/*!**************************************************************************************!*\
  !*** ./resources/js/pages/admin/withdrawals/show.vue?vue&type=template&id=ce223f12& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_show_vue_vue_type_template_id_ce223f12___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_show_vue_vue_type_template_id_ce223f12___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_show_vue_vue_type_template_id_ce223f12___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!../../../../../node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./show.vue?vue&type=template&id=ce223f12& */ "./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/withdrawals/show.vue?vue&type=template&id=ce223f12&");
